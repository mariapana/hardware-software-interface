...
add_byte_array_element:
    ...
    ; TODO: Compute the sum for elements in qword_array.

    ; TODO: Implement 128-bit addition example with big_qword_array.
    ; Hint: Store the 128-bit result in two 64-bit registers (rdx:rax)
    ; and don't forget about the carry.
